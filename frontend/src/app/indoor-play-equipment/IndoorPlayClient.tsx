...
export function IndoorPlayClient() {
  const { data: apiData } = useProductGroups("indoor-play");
  const groups = Array.isArray(apiData) ? apiData : [];

  const indoorSections = groups.map((g: any) => ({
    title: g.name,
        ...
        <div className="container-page">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Indoor Play Equipment</h1>
              <p className="text-lg text-gray-300 max-w-3xl leading-relaxed font-light">
                Complete range of indoor play systems including soft play units, crawl tunnels, slides, rideons, and EVA safety foam floorings. Built for malls, family centers, and restaurants.
              </p>
            </div>
